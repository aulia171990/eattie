          ...
          <div className="bg-white rounded-2xl border p-4 space-y-3" style={{ borderColor: 'hsl(36, 20%, 88%)' }}>
            <div className="flex justify-between items-start">
              ...
              <span
                ...
                style={{
                  background: result.payment_status === 'paid' ? 'hsl(142, 50%, 90%)' : 'hsl(36, 80%, 90%)',
                  color: result.payment_status === 'paid' ? 'hsl(142, 60%, 28%)' : 'hsl(32, 95%, 35%)',
                }}
              >
                {result.payment_status === 'paid' ? '✓ Lunas' : 'Belum Lunas'}
              </span>
            </div>
