...
import { LayoutDashboard, Package, ShoppingBag, BookOpen, Factory, Receipt, BarChart3, Briefcase, Settings, ShoppingCart, AlertTriangle, X, ClipboardList, Cake, Users, Star, Landmark, Scale, FileSearch } from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { title: 'Akuntansi', href: '/dashboard/accounting', icon: <Landmark size={18} />, roles: ['owner'] },
  { title: 'Piutang & Hutang', href: '/dashboard/ar-ap', icon: <Scale size={18} />, roles: ['owner'] },
  { title: 'Audit Log', href: '/dashboard/audit', icon: <FileSearch size={18} />, roles: ['owner'] },
