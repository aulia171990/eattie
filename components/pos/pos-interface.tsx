...
export function PosInterface({ products, cashierName }: PosInterfaceProps) {
  ...
  const productPanel = (
    <div className="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden">
      {/* Search + Category */}
      <div className="p-3 border-b bg-white shrink-0" style={{ borderColor: 'hsl(var(--border))' }}>
        <input
          type="text"
          ...
          {categories.map(cat => (
            <button
              ...
              style={activeCategory === cat
                ...
                : { background: 'hsl(var(--border))', color: 'hsl(var(--text-muted))' }
              }>
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
      ...
      <header
        ...
        style={{ background: 'hsl(var(--foreground))', borderColor: 'hsl(var(--sidebar-border))' }}
      >
      ...
      <div className="flex lg:hidden flex-col flex-1 min-h-0 overflow-hidden">
        ...
        >
          <button
            ...
            style={{ color: mobileTab === 'products' ? 'hsl(var(--primary))' : 'hsl(var(--text-muted))' }}
          >
            <Grid size={20} />
          ...
          <button
            ...
            style={{ color: mobileTab === 'cart' ? 'hsl(var(--primary))' : 'hsl(var(--text-muted))' }}
          >
