  ...
  return (
    <div className="p-6 space-y-6">
                ...
                <Link key={s.label} href={s.href}
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-lg lg:text-2xl font-bold mt-1.5 truncate" style={{ color: 'hsl(var(--foreground))' }}>{s.value}</p>
                      <p className="text-xs mt-1" style={{ color: 'hsl(var(--text-muted))' }}>{s.sub}</p>
                    </div>
            ...
            <div className="bg-white rounded-xl border p-5" style={{ borderColor: 'hsl(var(--border))' }}>
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/dashboard/reports/sales"
                  className="flex items-center gap-1 text-xs hover:underline" style={{ color: 'hsl(var(--primary))' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border p-5" style={{ borderColor: 'hsl(var(--border))' }}>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-sm" style={{ color: 'hsl(var(--foreground))' }}>Produksi Aktif</h2>
        ...
        {(isOwner || isCashier) && (
          <div className="bg-white rounded-xl border p-5" style={{ borderColor: 'hsl(var(--border))' }}>
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-semibold text-sm" style={{ color: 'hsl(var(--foreground))' }}>Transaksi Terbaru</h2>
