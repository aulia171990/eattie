...
--    given a product + optional variant, pick the variant-specific recipe
--    first; if none, fall back to the product's generic recipe.
--    p_variant_id may be NULL (caller doesn't know/care about variant).
